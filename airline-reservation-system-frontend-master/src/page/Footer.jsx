      ...
      <div class="container my-5">
        <footer class="text-center text-lg-start text-color">
            ...
            <section class="">
              <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                  ...
                  <p>
                  Welcome to InfoFlight - Your Gateway to Seamless Travel!

                 Experience the perfect blend of convenience and adventure with InfoFlight.
                 Our intuitive reservation system makes it easy to plan your travels, offering a wide selection of flights,
                 destinations, and class options.
                 Discover the joy of hassle-free booking and start your journey with InfoFlight today.
                  </p>
                </div>
          ...
          <div class="text-center">
            © 2024 Copyright:
            <a class="text-color-3" href="https://github.com/viveksahu06">
              INFOFLIGHT
            </a>
          </div>
        </footer>
